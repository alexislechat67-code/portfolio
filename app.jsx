...
function App() {
  ...
  React.useEffect(() => {
    ...
    root.style.setProperty('--accent', `oklch(0.68 0.18 ${tweaks.accentHue})`);
    root.style.setProperty('--accent-2', `oklch(0.80 0.10 ${tweaks.accentHue})`);
    root.style.setProperty('--accent-soft', `oklch(0.68 0.18 ${tweaks.accentHue} / 0.12)`);
  }, [tweaks.accentHue]);
