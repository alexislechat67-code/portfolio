      ...
      <div className="container">
        ...
        <div className="exp">
          <div className="exp-header reveal">
            ...
            <div className="exp-logo">
              <img src="assets/logoentreprise/logovhm.png" alt="VHM Groupe" />
            </div>
          </div>
          ...
          <div className="exp-trace reveal" style={{ cursor: 'pointer' }} onClick={() => onOpenTrace && onOpenTrace('dechets')}>
            ...
            <div className="exp-trace-img">
              <img src="assets/couverture/gestiondechets.png" alt="Dashboard RSE" />
            </div>
            <div className="exp-trace-cta">
              <span className="label-dim">Cliquer pour ouvrir le détail</span>
    ...
    <section id="situation">
      ...
      <div className="container">
        ...
        <div className="situation-intro reveal">
          ...
          <p>Dans le cadre du projet de suivi des déchets chez VHM Groupe, certaines factures fournisseur ne contenaient pas les quantités nécessaires au bon fonctionnement de l'outil.</p>
        </div>

        {/* Staircase graphique */}
        <div className="staircase reveal">
          {steps.map((s, i) => (
            <React.Fragment key={s.num}>
              <div className="stair-card" style={{ '--stair-i': i }}>
                <div className="stair-num">{s.num}</div>
                <div className="stair-content">
                  <h4 className="stair-title">{s.title}</h4>
                  <div className="stair-body">{s.body}</div>
                </div>
              </div>
              {i < steps.length - 1 && (
                <div className="stair-arrow" style={{ '--stair-i': i }}>
                  <svg viewBox="0 0 40 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <line x1="0" y1="12" x2="30" y2="12" stroke="currentColor" strokeWidth="1" strokeDasharray="4 3"/>
                    <polyline points="22,4 32,12 22,20" fill="none" stroke="currentColor" strokeWidth="1.5"/>
                  </svg>
                </div>
              )}
            </React.Fragment>
          ...
          {/* baseline */}
          <div className="stair-baseline"></div>
        </div>
