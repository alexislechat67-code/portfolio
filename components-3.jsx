...
const TRACE_DATA = [
  ...
  {
    key: 'dechets',
    eyebrow: 'Preuve / Trace · VHM Group',
    title: "Outil de pilotage de la",
    titleEm: 'gestion des déchets',
    titleEnd: '— Fichier Excel.',
    cover: 'assets/dechets/cover-tri-dechets.png',
    images: [
          ...
          {data.images.length > 3 ? (
            <>
              ...
              <div className="modal-gallery">
                {data.images.slice(1).map((src, j) => (
                  <div key={j} style={{ aspectRatio: '4/3', overflow: 'hidden', border: '1px solid var(--line)' }}>
                    <img src={src} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'top', filter: 'contrast(1.05)' }} />
                  </div>
                ))}
              </div>
            </>
